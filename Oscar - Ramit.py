...
\f0\fs24 \cf0 # oscar_transactions.py\
\
class Transaction:\
    def __init__(self):\
        self.ops = []\
...
\
    ...
    UPDATE basket SET status = \'91FROZEN\'92 WHERE id = :basket_id;\
    INSERT INTO session_data (key, value) VALUE (\'91order_number\'92, :order_number);\
